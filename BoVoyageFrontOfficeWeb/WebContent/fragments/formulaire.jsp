<div id="divFormContact">
	...
	<fieldset class="mdl-shadow--4dp">
		<legend class="mdl-shadow--4dp">Identification contact :</legend>
		<div
		...
		<div
			...
			<input class="mdl-textfield__input" type="password" name="password"
				id="password" /> <label class="mdl-textfield__label" for="password">Mot
				de Passe</label>
		</div>
		<div
			class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
	...
	<fieldset class="mdl-shadow--4dp">
		<legend class="mdl-shadow--4dp">Adresse contact :</legend>
		<div
			class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
	...
	<fieldset class="mdl-shadow--4dp">
		<legend class="mdl-shadow--4dp">Adresse de facturation contact :</legend>
		<div
			class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
		...
		<div
			class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<input class="mdl-textfield__input" type="text" name="postalCodeFact"
				id="postalCodeFact" /> <label class="mdl-textfield__label"
				for="postalCodeFact">Code Postal</label>
		</div>
		<br />
		<div
			class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<input class="mdl-textfield__input" type="text" name="cityFact"
				id="cityFact" /> <label class="mdl-textfield__label" for="cityFact">Ville</label>
		</div>
		<br />
		<div
			class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
